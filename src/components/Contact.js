      ...
      <div className='flex flex-col lg:flex-row'>
        ...
        <motion.form
          ...
          className='flex-1 border rounded-2xl flex flex-col gap-y-6 pb-12 p-6 items-start'>
            ...
            <textarea placeholder='Your message' className='bg-transparent border-b py-12 outline-none w-full placeholder:text-white focus:border-accent transition-all resize-none mb-12'></textarea>
